...
$sisa_pembayaran = $total_nominal-$nominal;
...
mysqli_query($koneksi, "update transaksi set transaksi_tanggal='$tanggal', nomor_induk='$nomor_induk', transaksi_jenis='$jenis', transaksi_kategori='$kategori', transaksi_nominal='$nominal', transaksi_keterangan='$keterangan', transaksi_bank='$bank',sisa_nominal='$sisa_pembayaran',total_nominal='$total_nominal' where transaksi_id='$id'") or die(mysqli_error($koneksi));
