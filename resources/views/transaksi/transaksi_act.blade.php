...
mysqli_query($koneksi, "insert into transaksi values (NULL,'$tanggal','$jenis','$kategori','$nominal','$keterangan','$bank','$total_nominal','$sisa_pembayaran')")or die(mysqli_error($koneksi));
